...
$question_query = "SELECT * FROM question WHERE online_exam_id =".$online_exam_id;
$options_query = "select options.question_id,options.option_title from options inner join
 question on options.question_id = question.question_id where question.online_exam_id =".$online_exam_id;
...
while ($row_options = mysqli_fetch_assoc($options_query_result))
   ...
   foreach($questions as $question){
      ...
      $final[$ques]["answer"] = $question["answer"];
