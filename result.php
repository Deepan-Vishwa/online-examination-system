<?php 
// Displays Completed Exam Results
...
<body>
                  ...
                  AND students.student_id = result.student_id where online_exam.end_time <= '".$curent_time."'
                    ...
                    <tr>
                        ...
                        <td><a href="#" class="badge"
                                data-result="<?php echo $row["result_final"]; ?>"><?php echo $row["result_final"]; ?></a>
                        </td>
                    </tr>
                    <?php 
                         }
    ...
    <script src="  https://cdn.datatables.net/rowreorder/1.2.7/js/dataTables.rowReorder.min.js" crossorigin="anonymous">
    </script>
    <script src="https://cdn.datatables.net/colreorder/1.5.2/js/dataTables.colReorder.min.js" crossorigin="anonymous">
    </script>
    ...
    // Badge color for pass, fail, absent
